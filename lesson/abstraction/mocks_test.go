...
func (_mock *MockUserRepository) CreateUser(user *User) error {
...
func (_c *MockUserRepository_CreateUser_Call) Run(run func(user *User)) *MockUserRepository_CreateUser_Call {
...
func (_mock *MockUserRepository) GetUserByID(id int) (*User, error) {
	ret := _mock.Called(id)
...
func (_c *MockUserRepository_GetUserByID_Call) Return(user *User, err error) *MockUserRepository_GetUserByID_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *MockUserRepository_GetUserByID_Call) RunAndReturn(run func(id int) (*User, error)) *MockUserRepository_GetUserByID_Call {
	_c.Call.Return(run)
	return _c
}
