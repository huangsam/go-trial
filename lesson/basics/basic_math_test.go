...
func TestAdd(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, basics.Add(tt.args.num1, tt.args.num2))
		})
	}
}
...
func TestSubtract(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, basics.Subtract(tt.args.num1, tt.args.num2))
		})
	}
}
...
func TestMultiply(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, basics.Multiply(tt.args.num1, tt.args.num2))
		})
	}
}
...
func TestDivide(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "DivisionByZero", args: args{num1: 5, num2: 0}, want: 0, wantErr: basics.ErrDivision},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := basics.Divide(tt.args.num1, tt.args.num2)
			if tt.wantErr != nil {
