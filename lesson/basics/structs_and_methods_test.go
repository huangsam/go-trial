...
var sampleAddress = basics.Address{Street: "1234 Magic Avenue", Zip: "12345-6789"}
...
func TestPersonFields(t *testing.T) {
	...
	person := basics.Person{expectedName, expectedAge, sampleAddress}
...
func TestPerson_IsOlderThan(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			person := basics.Person{"Jerry", tt.age, sampleAddress}
