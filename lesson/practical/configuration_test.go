...
func assertAppConfig(t *testing.T, cfg *practical.AppConfig) {
...
func TestJsonConfig(t *testing.T) {
	t.Run("Koanf", func(t *testing.T) {
		...
		var cfg practical.AppConfig
		require.NoError(t, k.Unmarshal("", &cfg))
		assertAppConfig(t, &cfg)
	})

	t.Run("Raw", func(t *testing.T) {
		cfg, err := practical.ReadJSONConfigRaw(testJSONPath)
...
func TestYamlConfig(t *testing.T) {
	...
	t.Run("Raw", func(t *testing.T) {
		cfg, err := practical.ReadYAMLConfigRaw(testYAMLPath)
		require.NoError(t, err)
		assertAppConfig(t, cfg)
	})
}
...
func BenchmarkJsonConfig(b *testing.B) {
	...
	b.Run("Raw", func(b *testing.B) {
		if _, err := practical.ReadJSONConfigRaw(testJSONPath); err != nil {
...
func BenchmarkYamlConfig(b *testing.B) {
	...
	b.Run("Raw", func(b *testing.B) {
		if _, err := practical.ReadYAMLConfigRaw(testYAMLPath); err != nil {
			b.Errorf("Unexpected error: %v", err)
		}
	})
}
