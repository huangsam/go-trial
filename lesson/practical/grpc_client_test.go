...
var (
	helloReq  = &pb.EchoRequest{Message: practical.HelloValue}
	helloResp = &pb.EchoResponse{Message: practical.HelloValue}
	doneReq   = &pb.EchoRequest{Message: practical.DoneValue}
	doneResp  = &pb.EchoResponse{Message: practical.DoneValue}
)
...
func TestEchoOnceWithClient(t *testing.T) {
	...
	err := practical.EchoOnceWithClient(context.Background(), client)
...
func TestEchoManyWithClient(t *testing.T) {
	...
	err := practical.EchoManyWithClient(context.Background(), client)
	require.NoError(t, err)
	client.AssertExpectations(t)
...
func TestLogClientUnaryInfo(t *testing.T) {
	...
	err := practical.LogClientUnaryInfo(ctx, method, helloReq, helloResp, cc, invoker)
	require.NoError(t, err)
}
...
func TestLogClientStreamInfo(t *testing.T) {
	...
	clientStream, err := practical.LogClientStreamInfo(ctx, desc, cc, method, streamer)
	require.NoError(t, err)
